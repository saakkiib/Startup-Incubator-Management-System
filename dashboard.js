...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadStartups() {
        ...
        try {
            ...
            // Filter by user if needed, for now show all for demo
            ...
            `).join('') || '<p class="text-muted">No startups found. Click "+ New Startup" to begin.</p>';
        } catch (err) {
            dynamicContent.innerHTML = '<p class="error-msg">Failed to load startups.</p>';
        }
    }
    ...
    function loadDocs() { dynamicContent.innerHTML = '<h3>Pitch Documents</h3><p>Feature coming soon...</p>'; }
    function loadAssignments() { dynamicContent.innerHTML = '<h3>Assignments</h3><p>Manage your assigned startups here.</p>'; }
    function loadExplore() { dynamicContent.innerHTML = '<h3>Explore Network</h3><p>Discover high-potential startups to fund.</p>'; }
